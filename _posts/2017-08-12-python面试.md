...
- [37. re的match和search区别？](#_label0_45)
- [38. 什么是正则的贪婪匹配？](#_label0_46)
- [39. 求结果：](#_label0_47)
- [40. 求结果：](#_label0_48)
- [ 41、def func(a,b=[]) 这种写法有什什么坑？](#_label0_49)
- [42、如何实现 1,2,3 变成 [1,2,3]](#_label0_50)
- [43. 如何实现[1,2,3]变成[1,2,3]](#_label0_51)
- [44. a = [1,2,3] 和 b = [(1),(2),(3) ] 以及 b = [(1,),(2,),(3,) ] 的区别？](#_label0_52)
- [45. 如何用一行代码生成[1,4,9,16,25,36,49,64,81,100]](#_label0_53)
- [46. 一行代码实现删除列表中重复的值](#_label0_54)
- [47. 如何在函数中设置一个全局变量](#_label0_55)
- [48. logging模块的作用？以及应用场景？](#_label0_56)
- [49. 请用代码简答实现stack](#_label0_57)
- [50. 常用字符串格式化哪几种？](#_label0_58)
- [51. 简述 生成器、迭代器、可迭代对象 以及应用场景？](#_label0_59)
- [迭代器](#_label0_60)
- [生成器](#_label0_61)
- [可迭代对象](#_label0_62)
- [装饰器](#_label0_63)
- [ 52. 用Python实现一个二分查找的函数。](#_label0_64)
- [53. 谈谈你对闭包的理解？](#_label0_65)
- [54. os和sys模块的作用？](#_label0_66)
- [55. 如何生成一个随机数？](#_label0_67)
- [56. 如何使用python删除一个文件？](#_label0_68)
- [57. 谈谈你对面向对象的理解](#_label0_69)
- [58. Python面向对象中的继承有什么特点](#_label0_70)
- [59. 面向对象深度优先和广度优先是什么？](#_label0_71)
- [60. 面向对象中super的作用？](#_label0_72)
- [61. 是否使用过functools中的函数？其作用是什么？](#_label0_73)
- [62. 列举面向对象中带双下划线的特殊方法，如：__new__、__init__](#_label0_74)
- [63. 如何判断是函数还是方法？](#_label0_75)
- [64. 静态方法和类方法区别？](#_label0_76)
- [65. 列举面向对象中的特殊成员以及应用场景](#_label0_77)
- [66. 1、2、3、4、5 能组成多少个互不相同且无重复的三位数](#_label0_78)
- [67. 什么是反射？以及应⽤用场景？](#_label0_79)
- [68. metaclass作用？以及应用场景？](#_label0_80)
- [69. 用尽量多的方法实现单例模式。](#_label0_81)
- [70. 装饰器器的写法以及应用场景。](#_label0_82)
- [71. 异常处理写法以及如何主动跑出异常（应用场景）](#_label0_83)
- [72、什么是面向对象的mro](#_label0_84)
- [73. isinstance作用以及应用场景？](#_label0_85)
- [74. 写代码并实现](#_label0_86)
- [75. json序列化时，可以处理的数据类型有哪些？如何定制支持datetime类型？](#_label0_87)
- [76. json序列化时，默认遇到中文会转换成unicode，如果想要保留中文怎么办？](#_label0_88)
- [77. 什么是断言？应用场景？](#_label0_89)
- [78. 有用过with statement吗？它的好处是什么？](#_label0_90)
- [79. 使用代码实现查看列举目录下的所有文件。](#_label0_91)
- [80. 简述 yield和yield from关键字](#_label0_92)

- [81. 简述 OSI 七层协议。](#_label1_0)
- [82. 什么是C/S和B/S架构？](#_label1_1)
- [83. 简述 三次握手、四次挥手的流程。](#_label1_2)
- [84. TCP和UDP的区别？](#_label1_3)
- [85. 为何基于tcp协议的通信比基于udp协议的通信更可靠？](#_label1_4)
- [86. 什么是socket？简述基于tcp协议的套接字通信流程。](#_label1_5)
- [87. 什么是粘包？ socket 中造成粘包的原因是什什么？ 哪些情况会发生粘包现象？](#_label1_6)
- [88. IO多路复的作用？](#_label1_7)
- [89.select、poll、epoll 模型的区别？（属于多路复用IO的模型）](#_label1_8)
- [90. 什么是防火墙以及作用？](#_label1_9)
- [91. 简述 进程、线程、协程的区别 以及应用场景？](#_label1_10)
- [92. GIL锁是什么？](#_label1_11)
- [93. Python中如何使用线程池和进程池？](#_label1_12)
- [94. threading.local的作用？](#_label1_13)
- [95. 进程之间如何进行通信？](#_label1_14)
- [96. 什么是并发和并行？](#_label1_15)
- [97. 进程锁和线程锁的作用？](#_label1_16)
- [98. 解释什么是异步非阻塞？](#_label1_17)
- [99. 路由器和交换机的区别](#_label1_18)
- [100.什么是域名解析？](#_label1_19)
- [101.如何修改本地hosts件？](#_label1_20)
- [102.生产者消费者模型应用场景及优势？](#_label1_21)
- [103.什么是cdn？](#_label1_22)
- [104.LVS是什么及作用？](#_label1_23)
- [105.Nginx是什么及作用？](#_label1_24)
- [106.keepalived是什么及作用?](#_label1_25)
- [107.haproxy是什么以及作用？](#_label1_26)

- [113.列举常见的关系型数据库和非关系型都有那些？](#_label2_0)
- [114.MySQL常见数据库引擎及比较？](#_label2_1)
- [115.简述数据库三大范式？](#_label2_2)
- [116、什么是事务？MySQL如何支持事务？](#_label2_3)
- [117.简述数据库设计中一对多和多对多的应用场景？](#_label2_4)
- [118.如何基于数据库实现商城商品计数器？](#_label2_5)
- [119.常见SQL（必备）](#_label2_6)
- [120.简述触发器、函数、视图、存储过程？](#_label2_7)
- [121.MySQL索引种类](#_label2_8)
- [122.索引在什么情况下遵循最左前缀的规则？](#_label2_9)
- [123.主键和外键的区别？](#_label2_10)
- [124.MySQL常见的函数？](#_label2_11)
- [125.列举 创建索引但是无法命中索引的8种情况。](#_label2_12)
- [126.如何开启慢日志查询？](#_label2_13)
- [127.数据库导入导出命令（结构+数据）？](#_label2_14)
- [128.数据库优化方案？](#_label2_15)
- [129.char和varchar的区别？](#_label2_16)
- [130.简述MySQL的执行计划？](#_label2_17)
- [131.在对name做了唯一索引前提下，简述以下区别：     ](#_label2_18)
- [132.1000w条数据，使用limit offset 分页时，为什么越往后翻越慢？如何解决？](#_label2_19)
- [133.什么是索引合并？](#_label2_20)
- [134.什么是覆盖索引？](#_label2_21)
- [135.简述数据库读写分离？](#_label2_22)
- [136.简述数据库分库分表？（水平、垂直）](#_label2_23)
- [137.redis和memcached比较？](#_label2_24)
- [138.redis中数据库默认是多少个db 及作用？](#_label2_25)
- [139.python操作redis的模块？](#_label2_26)
- [140.如果redis中的某个列表中的数据量非常大，如果实现循环显示每一个值？](#_label2_27)
- [141.redis如何实现主从复制？以及数据同步机制？](#_label2_28)
- [142.redis中的sentinel的作用？](#_label2_29)
- [143.如何实现redis集群？](#_label2_30)
- [144.redis中默认有多少个哈希槽？](#_label2_31)
- [145.简述redis的有哪几种持久化策略及比较？](#_label2_32)
- [146.列举redis支持的过期策略。](#_label2_33)
- [147.MySQL 里有 2000w 数据，redis 中只存 20w 的数据，如何保证 redis 中都是热点数据？ ](#_label2_34)
- [148.写代码，基于redis的列表实现 先进先出、后进先出队列、优先级队列。](#_label2_35)
- [149.如何基于redis实现消息队列？](#_label2_36)
- [150.如何基于redis实现发布和订阅？以及发布订阅和消息队列的区别？](#_label2_37)
- [151.什么是codis及作用？](#_label2_38)
- [152.什么是twemproxy及作用？](#_label2_39)
- [153.写代码实现redis事务操作。](#_label2_40)
- [154.redis中的watch的命令的作用？](#_label2_41)
- [155.基于redis如何实现商城商品数量计数器？](#_label2_42)
- [156.简述redis分布式锁和redlock的实现机制。](#_label2_43)
- [157.什么是一致性哈希？Python中是否有相应模块？](#_label2_44)
- [158.如何高效的找到redis中所有以aaa开头的key？](#_label2_45)

- [1.谈谈你对http协议的认识。](#_label3_0)
...
- [60.django rest framework框架中都有那些组件？](#_label3_64)
...
- [scrapy中的pipelines工作原理？](#_label3_128)
...
修改后用浏览器访问www.163.com会被解析到127.0.0.1，导致无法显示该网页。
```
...
<img src="https://images2018.cnblogs.com/blog/1258691/201805/1258691-20180529171742982-1852627222.png" alt="" width="464" height="176" />
...
<body>
    ...
    <ul>
            ...
            <li style="cursor: pointer" id="user_
...
<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193331193-1780213562.png" alt="" width="236" height="270" />

<a name="_label3_18"></a>

### 看图写结果（js）：

<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193350024-1394121124.png" alt="" />

<a name="_label3_19"></a>

### 看图写结果：（js）

<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193402254-925709250.png" alt="" />

<a name="_label3_20"></a>

### 看图写结果：（js）

<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193412085-688600397.png" alt="" />
...
<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193421487-536908496.png" alt="" />
...
<img src="https://images2018.cnblogs.com/blog/425762/201805/425762-20180523193433388-1947519928.png" alt="" />
...
<img src="https://images2018.cnblogs.com/blog/1258691/201806/1258691-20180601114444453-1347550743.png" alt="" width="695" height="239" />
...
```
方案：先发送GET请求时，将token保存到：cookie、Form表单中（隐藏的input标签），以后再发送请求时只要携带过来即可。 ContentType contenttype是django的一个组件（app），为我们找到django程序中所有app中的所有表并添加到记录中。 可以使用他再加上表中的两个字段实现：一张表和N张表创建FK关系。 - 字段：表名称 - 字段：数据行ID 应用：路飞表结构优惠券和专题课和学位课关联。
```
...
<img src="https://images2018.cnblogs.com/blog/1258691/201806/1258691-20180601133706615-2118245019.png" alt="" width="666" height="215" />
...
<strong>
方式二：需要先下载jQuery</strong>**-****cookie，才能去cookie中获取token**
        function Do1(){
        $.ajax({
            url:"/index/",
            data:{id:1},
...
路由系统中name的作用：反向解析url**(****r'^home'**, views.home, name**=****'home'****)******在模板中使用：**{ ****% **url **'home' ****%****}******在视图中使用：reverse**(**home）
...
1、模板继承：**{ ****% **extends **'layouts.html' ****%****}******2、自定义方法      **'filter'**：只能传递两个参数，可以在if、for语句中使用    **'simple_tag'**：可以无线传参，不能在if for中使用    **'inclusion_tags'**：可以使用模板和后端数据3、防xss攻击： **'|safe'**、**'mark_safe'**
...
<img src="https://images2018.cnblogs.com/blog/1258691/201806/1258691-20180604131035243-475790859.png" alt="" />
...
-----------------------------------------------------------------------
不正确：
    Ctime字段中参数应为default=datetime.now
...
### Tornado中静态文件是如何处理的？ 如： <link href="
...
<a name="_label3_100"></a>

### git如何实现v1.0 、v2.0 等版本的管理？

```
在命令行中，使用git tag a tagname m comment可以快速创建一个标签。
需要注意，命令行创建的标签只存在本地Git库中，还需要使用Git push tags指令发布到服务器的Git库中
```

<a name="_label3_101"></a>
...
<a name="_label3_104"></a>

### git中 .gitignore文件的作用

```
一般来说每个Git项目中都需要一个.gitignore文件，
这个文件的作用就是告诉Git哪些文件不需要添加到版本管理中。

实际项目中，很多文件都是不需要版本管理的，比如Python的.pyc文件和一些包含密码的配置文件等等。
```

<a name="_label3_105"></a>
...
<a name="_label3_107"></a>

### 公司如何实现代码发布？

```
[nginx+uwsgi+django](https://www.cnblogs.com/wupeiqi/articles/8591782.html)
```

<a name="_label3_108"></a>
...
<a name="_label3_109"></a>

### [RabbitMQ](http://www.cnblogs.com/yuanchenqi/articles/8507109.html)如何在消费者获取任务后未处理完前就挂掉时，保证数据不丢失？
...
type=topic  队列绑定几个模糊的关键字，之后发送者将数据发送到exchange，exchange将传入路由值和 关键字进行匹配，匹配成功，则将数据发送到指定队列。
---------------------------------------------------
发送者路由值              队列中
...
<a name="_label3_114"></a>

### 简述celery运行机制。

<a name="_label3_115"></a>
...
<a name="_label3_118"></a>

### 简述 [requests](http://www.cnblogs.com/linhaifeng/articles/7785043.html)模块的作用及基本使用？
...
<a name="_label3_125"></a>

### [scrapy中如何实现暂停爬虫？](https://scrapy-chs.readthedocs.io/zh_CN/1.0/topics/jobs.html?highlight=item)
...
<a name="_label3_126"></a>

### scrapy中如何进行[自定制命令](http://www.cnblogs.com/wupeiqi/articles/6229292.html)？
...
<a name="_label3_129"></a>

### scrapy的pipelines如何丢弃一个item对象？

通过raise DropItem**()**方法

<a name="_label3_130"></a>
...
<a name="_label3_133"></a>

### scrapy-redis的调度器如何实现任务的深度优先和广度优先？....

<a name="_label3_134"></a>

### [简述 vitualenv ](https://blog.csdn.net/u012734441/article/details/55044025/)及应用场景?
...
3）NedBatchelders McCabe script：静态分析Python代码复杂度的工具。
Python代码分析工具：PyChecker、Pylint
```

<a name="_label3_137"></a>

### 简述 saltstack、ansible、fabric、puppet工具的作用？

<a name="_label3_138"></a>
...
<a name="_label3_140"></a>

###  请列举常见查找并通过代码实现任意三种。

```
[无序查找、二分查找、插值查找](http://www.cnblogs.com/feixuelove1009/p/6148357.html)
```

<a name="_label3_141"></a>

### 请列举你熟悉的[设计模式](http://www.cnblogs.com/haiyan123/p/8407453.html)？

```
工厂模式/单例模式等
```

<a name="_label3_142"></a>
...
<a name="_label3_143"></a>

### [列举熟悉的的Linux命令。](https://www.cnblogs.com/jassin-du/p/8973891.html)
...
<a name="_label3_154"></a>

### 是否了解过领域[驱动模型](https://www.cnblogs.com/netfocus/archive/2011/10/10/2204949.html)？

```
Domain-Driven Design
```

## [ ](http://www.cnblogs.com/jassin-du/p/9003837.html)
